...
public class WorkoutLegsActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Populate spinner
        Spinner exerciseSpinner = (Spinner) findViewById(R.id.spinner_legs);
    ...
    private DatePickerDialog.OnDateSetListener mDateSetListener =
	    new DatePickerDialog.OnDateSetListener() {
	        ...
	        public void onDateSet(DatePicker view, int year, 
	            ...
	            workoutDateText.setText(WorkoutStartTabWidget.selectedDay + "/" + WorkoutStartTabWidget.selectedMonth + "/" + WorkoutStartTabWidget.selectedYear);
	        }
	    };
